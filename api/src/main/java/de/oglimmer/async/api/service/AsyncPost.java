...
public class AsyncPost extends HttpServlet {
	...
	/**
	 * Access via client/get.sh http://localhost:8080/asyncPost
	 */
	@Override
	...
	/**
	 * Access via client/post.sh http://localhost:8080/asyncPost
	 */
	@Override
